...
from database import load_signin, load_user, do_signup, load_admin, check_user, check_admin, put_slip_request, load_slip, load_bridge_slip, passed_slip, load_pass_slip,load_data
...
@app.route("/SignIn/welcome/student")
def student():
  user = load_user(user_id)
  return render_template('user.html',user=user)

@app.route("/SignIn/welcome/admin")
def ad():
